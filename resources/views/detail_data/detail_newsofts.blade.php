...
<head>
    ...
    <title>SIM IT Support |Detail Pengelolaan Software Baru</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"><i class="nav-icon fas fa-tasks"></i>&nbsp;Detail Pengelolaan Software Baru</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item active">Detail Pengelolaan Software Baru</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3>{{ $newsofts2->count()}}</h3>

                        <p>Total Detail Data Software Baru</p>
                    </div>
                    <div class="icon">
                        <i class="nav-icon fas fa-laptop-code"></i>
                    </div>
                    <a href="{{url('newsoft2')}}" class="small-box-footer">Info lainnya <i
