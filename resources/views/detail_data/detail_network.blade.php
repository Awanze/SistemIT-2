                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-secondary">
                                <div class="inner">
                                    <h3>{{ $networks2->count()}}</h3>

                                    <p>Total Detail Data Network</p>
                                </div>
                                <div class="icon">
