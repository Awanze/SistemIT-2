...
<head>
    ...
    <title>SIM IT Support | Master Progress</title>
...
<body class="hold-transition sidebar-mini">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <div class="icon">
                                <h1><i class="nav-icon fas fa-layer-group"></i>&nbsp;Data Progress
                            </div>
                            </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Master Progress</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row mb-2">
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <button class="edit-modal btn-sm btn-info"
                                                    data-id_progress="{{$p->id_progress}}"
                                                    data-nama_progress="{{$p->nama_progress}}">
                                                    <i class="nav-icon fas fa-edit">&nbsp;Ubah</i>
                                                </button>
                                            </td>
                                            <td class="project-actions text-left">
                                                <form
                                                    action="{{route('progress.destroy',['id_progress'=>$p->id_progress])}}"
                                                    method="POST">
    ...
    <div id="addModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <form action="{{ route('progress.store')}}" method="post" enctype="multipart/form-data" id="form-data">
                    {{ csrf_field() }}
                    <!-- heading modal -->
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="id_prog" hidden>ID Progress</label>
                            <input type="text" id="id_prog" name="id_progress" class="form-control" hidden>

                            @if($errors->has('id_progress'))
                            <div class="text-danger">
                                {{ $errors->first('id_progress')}}
                        ...
                        <div class="form-group">
                            <label for="nama_progress">Nama Progress</label>
                            <input type="text" id="nama_prog" name="nama_progress"
                                onkeypress="return event.charCode < 48 || event.charCode  >57"
                                placeholder="Masukan Nama Progress" required="required" class="form-control">

                            @if($errors->has('nama_progress'))
                            <div class="text-danger">
                                {{ $errors->first('nama_progress')}}
                            </div>
                            @endif
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.edit-modal', function () {
            ...
            $('.modal-title').text('Input Data Progress');
            $('.form-horizontal').show();
            $('#id_prog').val($(this).data('id_progress'));
            $('#nama_prog').val($(this).data('nama_progress'));
            $('#addModal').modal('show');
        });
