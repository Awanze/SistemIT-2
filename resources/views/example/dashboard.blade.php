              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{url('/lte/dist/img/user1-128x128.jpg')}}" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{url('/lte/dist/img/user3-128x128.jpg')}} alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                  ...
                  <ul class="contacts-list">
                    <li>
                      <a href="{{url('dashboard')}}">
                        <img class="contacts-list-img" src="{{url('/lte/dist/img/user1-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="{{url('dashboard')}}">
                        <img class="contacts-list-img" src="{{url('/lte/dist/img/user7-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="{{url('dashboard')}}">
                        <img class="contacts-list-img" src="{{url('/lte/dist/img/user3-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="{{url('dashboard')}}">
                        <img class="contacts-list-img" src="{{url('/lte/ist/img/user5-128x128.jpg')}}>
                    ...
                    <li>
                      <a href="{{url('dashboard')}}">
                        <img class="contacts-list-img" src="{{url('/lte/dist/img/user6-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="{{url('dashboard')}}">
                        <img class="contacts-list-img" src="{{url('/lte/dist/img/user8-128x128.jpg')}}">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="pagination pagination-sm">
                    <li class="page-item"><a href="{{url('dashboard')}}" class="page-link">&laquo;</a></li>
                    <li class="page-item"><a href="{{url('dashboard')}}" class="page-link">1</a></li>
                    <li class="page-item"><a href="{{url('dashboard')}}" class="page-link">2</a></li>
                    <li class="page-item"><a href="{{url('dashboard')}}" class="page-link">3</a></li>
                    <li class="page-item"><a href="{{url('dashboard')}}" class="page-link">&raquo;</a></li>
                  </ul>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu float-right" role="menu">
                      <a href="{{url('dashboard')}}" class="dropdown-item">Add new event</a>
                      <a href="{{url('dashboard')}}" class="dropdown-item">Clear events</a>
                      <div class="dropdown-divider"></div>
                      <a href="{{url('dashboard')}}" class="dropdown-item">View calendar</a>
                    </div>
                  </div>
