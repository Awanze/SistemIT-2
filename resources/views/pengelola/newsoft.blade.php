...
<head>
    ...
    <title>SIM IT Support | Pengelolaan Software dan Games Baru</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"><i class="nav-icon fas fa-tasks"></i>&nbsp;Pengelolaan Software
                                Baru</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item active">Pengelolaan Software Baru</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            @can('update_newsoft')
                            <a href="{{route('newsoft.create')}}"><button type="button" class="btn btn-success float-right" title="Tambah Baru">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">List Data Software Baru</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <a href="{{route('newsoft.view',[ 'id_nsoft'=>$p->id_nsoft])}}"
                                            ...
                                            @can('update_newsoft')
                                            <td class="project-actions text-right">
                                                <a href="{{route('newsoft.edit',[ 'id_nsoft'=>$p->id_nsoft])}}"
                                                    class="btn btn-sm btn-warning">
                                                <i class="nav-icon fas fa-edit">&nbsp;Ubah</i>
                                                </a>
                                            </td>
                                            <td class="project-actions text-left">
                                            <form action="{{route('newsoft.destroy',['id_nsoft'=>$p->id_nsoft])}}" method="POST">
                                            {{ csrf_field() }}
