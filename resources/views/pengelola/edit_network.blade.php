...
<head>
    ...
    <title>SIM IT Support | Edit Data Network</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="nav-icon fas fa-edit"></i>&nbsp;Ubah Data Network</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item active">Edit Data Network</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="Input_Network">Permintaan</label>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="i_company" name="i_company"
                                                        required="required" value="{{ $networks->i_company}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control float-right"
                                                            ...
                                                            value="{{ $networks->tgl_mpemasangan}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control float-right"
                                                            ...
                                                            value="{{ $networks->tgl_apemasangan}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
      ...
      <tr>
        ...
        <td><input type="text" name="l_pemasangan[]" id="l_pemasangan" 
            placeholder="Masukan Letak Pemasangan" class="form-control"  required="required" />
        </td>
