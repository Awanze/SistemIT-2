...
<head>
    ...
    <title>SIM IT Support | View Data Software Baru</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="nav-icon fas fa-edit"></i>&nbsp;View Data Software Baru</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item active">View Data Software Baru</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <a href="{{route('newsoft.print',[ 'id_nsoft'=>$newsofts->id_nsoft])}}"><button type="button"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="r_nsoft" name="r_nsoft" class="form-control"
                                                        ...
                                                        placeholder="Masukan Permintaan/Masalah" required="required" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="inputClientCompany" name="n_soft"
                                                        ...
                                                        value="{{ $newsofts->n_soft}}" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="inputProjectLeader" name="j_soft"
                                                        ...
                                                        value="{{ $newsofts->j_soft}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-md-3">
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control" id="nsoft_programmer"
                                                      name="nsoft_programmer" required="required" disabled>
                                          ...
                                          <div class="col-md-3">
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control" id="nsoft_itsupport"
                                                      name="nsoft_itsupport" required="required" disabled>
                                                      <option selected disabled></option>
                                                      @foreach ($its as $it)
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="input-group">
                                                      ...
                                                      <input type="text" class="form-control float-right"
                                                          ...
                                                          value="{{ $newsofts->tgl_ssoft}}" disabled>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
                                        ...
                                        <table class="table table-bordered" id="dynamicAddRemove">
                                            ...
                                            <tr>
                                                <td><input type="text" name="d_nsoft[]" id="d_nsoft"
                                                        placeholder="Masukan Detail Masalah/Request" value="{{$item->d_nsoft}}" class="form-control" required disabled/>
                                                </td>
                                                <td><input type="text" name="n_fitur[]" id="n_fitur"
                                                        placeholder="Masukan Fitur" class="form-control" value="{{$item->n_fitur}}" required disabled/>
                                                </td>
    ...
    <script type="text/javascript">
      ...
      <tr>
        <td><input type="text" name="d_nsoft[]" id="d_nsoft"
            placeholder="Masukan Detail Masalah/Request" class="form-control" required disabled/>
        </td>
        <td><input type="text" name="n_fitur[]" id="n_fitur"
            placeholder="Masukan Fitur" class="form-control" value="{{$item->n_fitur}}" required disabled/>
        </td>
        <td><select class="form-control" id="i_nsstatus" name="i_nsstatus[]" required="required" disabled>
            <option selected disabled> --Pilih Status-- </option>
            @foreach ($status as $stat)
            <option value="{{ $stat->id_status }}" @if($stat->id_status == $item->i_nsstatus) selected @endif>{{ $stat->nama_status }}</option>
            @endforeach
        </select></td>
        <td><select class="form-control" id="i_nsprog" name="i_nsprog[]" required="required" disabled>
            <option selected disabled> --Pilih Progress-- </option>
            @foreach ($progress as $prog)
        <option value="{{ $prog->id_progress }}" @if($prog->id_progress == $item->i_nsprog) selected @endif>{{ $prog->nama_progress }}</option>
            @endforeach
