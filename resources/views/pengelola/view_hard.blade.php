...
<head>
    ...
    <title>SIM IT Support | View Data Hardware</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="nav-icon fas fa-edit"></i>&nbsp;View Data Hardware</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item active">View Data Hardware</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <a href="{{route('hardware.print',[ 'id_hard'=>$hardware->id_hard])}}"><button type="button"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="m_hard" name="m_hard" required="required"
                                                        ...
                                                        value="{{ $hardware->m_hard}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="i_staff" name="i_staff" class="form-control"
                                                        ...
                                                        value="{{ $hardware->i_staff}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input name="tgl_perbaikan" type="text"
                                                            ...
                                                            required="required" value="{{ $hardware->tgl_perbaikan}}" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> <select class="form-control" id="i_prog"
                                                                        name="i_prog[]" required="required" disabled>
    ...
    <script type="text/javascript">
      ...
      <tr>
        <td><input type="text" name="dm_hard[]" id="dm_hard"
            placeholder="Masukan Detail Perbaikan" class="form-control" required value="{{ $item->dm_hard }}" disabled/>
        </td>
        <td><input type="text" name="j_komputer[]" id="j_komputer"
            placeholder="Masukan Jenis Komputer" class="form-control" required value="{{ $item->j_komputer }}" disabled/>
        </td>
        <td><input type="text" name="k_rusak[]" id="k_rusak"
            placeholder="Masukan Komponen Rusak" class="form-control"  required value="{{ $item->k_rusak }}" disabled/>
        </td>
        <td><select class="form-control" id="i_status" name="i_status[]" required="required" disabled>
            <option selected disabled> --Pilih Status-- </option>
            @foreach ($status as $stat)
            <option value="{{ $stat->id_status }}" @if($stat->id_status == $item->i_status) selected @endif>{{ $stat->nama_status }}</option>
            @endforeach
        </select></td>
        <td><select class="form-control" id="i_prog" name="i_prog[]" required="required" disabled>
            <option selected disabled> --Pilih Progress-- </option>
            @foreach ($progress as $prog)
        <option value="{{ $prog->id_progress }}" @if($prog->id_progress == $item->i_prog) selected @endif>{{ $prog->nama_progress }}</option>
            @endforeach
        </select></td>
    </tr>
    </body>`);
