...
<head>
    ...
    <title>SIM IT Support | Pengelolaan Network</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"><i class="nav-icon fas fa-tasks"></i>&nbsp;Pengelolaan Network
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item active">Pengelolaan Network</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{route('network.create')}}">
                                <button type="button" class="btn btn-success float-right"><i
                                        class="nav-icon fas fa-file" title="Tambah Baru">&nbsp;Tambah Baru</i></button></a>
                                        @else
                                ...
                                <table id="example1" class="table table-noborder table-stripedw">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 15%">
                                                Tgl Mulai Pemasangan
                                            </th>
                                            <th style="width: 15%">
                                                Tgl Selesai Pemasangan
                                            </th>
                                            <th style="width: 5%">
                                            </th>
                                            <th style="width: 5%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <a href="{{route('network.view',[ 'id_net'=>$p->id_net])}}"
                                            ...
                                            @can('update_network')
                                            <td class="project-actions text-right">
                                                <a href="{{route('network.edit',[ 'id_net'=>$p->id_net])}}"
                                                    class="btn btn-sm btn-warning">
                                                    <i class="nav-icon fas fa-edit">&nbsp;Ubah</i>
                                                </a>
                                            </td>
                                            <td class="project-actions text-left">
                                                <form action="{{route('network.destroy',['id_net'=>$p->id_net])}}"
                                                    method="POST">
