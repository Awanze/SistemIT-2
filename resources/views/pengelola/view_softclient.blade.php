...
<head>
    ...
    <title>SIM IT Support | View Software Client</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="nav-icon fas fa-edit"></i>&nbsp;View Data Software Client</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item active">View Data Software Client</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <a href="{{route('softclient.print',[ 'id_sclient'=>$softclients->id_sclient])}}"><button type="button"
                                          ...
                                          <div class="col-md-4">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" id="inputProjectLeader" name="n_sclient"
                                                      ...
                                                      value="{{ $softclients->n_sclient}}" disabled>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control float-right"
                                                            ...
                                                            value="{{ $softclients->tgl_ssoftclient}}" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-bordered" id="dynamicAddRemove">
                                            ...
                                            <tr>
                                                <td><input type="text" name="d_sclient[]" id="d_sclient"
                                                        ...
                                                        class="form-control" value="{{$item->d_sclient}}" required disabled/>
                                                </td>
                                                <td><input type="text" name="c_fitur[]" id="c_fitur"
                                                        placeholder="Masukan Fitur" class="form-control" value="{{$item->c_fitur}}" required disabled/>
                                                </td>
    ...
    <script type="text/javascript">
      ...
      <tr>
        <td><input type="text" name="d_sclient[]" id="d_sclient"
            placeholder="Masukan Detail Masalah/Request" class="form-control" value="{{$item->d_sclient}}" required disabled/>
        </td>
        <td><input type="text" name="c_fitur[]" id="c_fitur"
            placeholder="Masukan Fitur" class="form-control" value="{{$item->c_fitur}}" required disabled/>
        </td>
        <td><select class="form-control" id="i_cstatus" name="i_cstatus[]" required="required" disabled>
            <option selected disabled> --Pilih Status-- </option>
            @foreach ($status as $stat)
        <option value="{{ $stat->id_status }}" @if($stat->id_status == $item->i_cstatus) selected @endif>{{ $stat->nama_status }}</option>
            @endforeach
        </select></td>
        <td><select class="form-control" id="i_cprog" name="i_cprog[]" required="required" disabled>
            <option selected disabled> --Pilih Progress-- </option>
            @foreach ($progress as $prog)
        <option value="{{ $prog->id_progress }}" @if($prog->id_progress == $item->i_cprog) selected @endif>{{ $prog->nama_progress }}</option>
            @endforeach
