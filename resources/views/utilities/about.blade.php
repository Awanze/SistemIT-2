...
<head>
    ...
    <title>SIM IT Support | About</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <center><img width="300px"  src="{{url('/lte/dist/img/log-mitrait-new.png')}}" ></img>
                                <h5>Pemilik   : TEGUH SANTOSO (OWNER)<br>
                                Telepon  : (0361) 485468<br>
                                Website  : http://mitra-it.com/<br>
                                Alamat    : Jl. Gunung Indrakila No.69 Monang-maning, DENPASAR
                                </h5></center>
                            </div>
    ...
    <!-- AdminLTE Pengelolaan Hardware demo (This is only for demo purposes) -->
    {{-- <script src="{{url('/lte/dist/js/pages/Dashboard.js')}}"></script> --}}
    <!-- AdminLTE for demo purposes -->
    <script src="{{url('/lte/dist/js/demo.js')}}"></script>
    <script> 
    //form about aktif
    $('#formabout').addClass('active');
    </script>
</body>
